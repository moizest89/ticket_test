...
i1 = Item.create({description: "lorem ipsum", category_id: c1.id, user_id: u2.id})
i1 = Item.create({description: "lorem ipsum", category_id: c2.id, user_id: u2.id})
i1 = Item.create({description: "lorem ipsum", category_id: c3.id, user_id: u2.id})
i1 = Item.create({description: "lorem ipsum", category_id: c4.id, user_id: u2.id})
i1 = Item.create({description: "lorem ipsum", category_id: c5.id, user_id: u3.id})
i1 = Item.create({description: "lorem ipsum", category_id: c6.id, user_id: u3.id})
i1 = Item.create({description: "lorem ipsum", category_id: c7.id, user_id: u2.id})
i1 = Item.create({description: "lorem ipsum", category_id: c8.id, user_id: u2.id})
